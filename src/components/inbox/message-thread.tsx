...
export function MessageThread({
  ...
  const contactDisplayName = contact?.name || contact?.phone || conversation?.contact_phone || "Unknown";
  ...
  const displayPhone = contact?.phone || conversation?.contact_phone || "Unknown";
